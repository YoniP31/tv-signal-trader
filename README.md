...
Refreshed on startup/shutdown, whenever `web` touches something worth recording, and by a background `LoginMonitor` thread that runs every `LOGIN_POLL_INTERVAL_SECONDS` (15s) and does double duty:
